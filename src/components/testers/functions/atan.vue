...
<template>
                        ...
                        <div
                            ...
                            :style="{
                                transform: `rotate(${Math.round(
                                    Math.atan(this.propertyValue) * (180 / Math.PI)
                                )}deg)`
                            }"
                        />
                    </div>
                ...
                <TestInformation>
                    ...
                    <TestConverted v-if="this.$i18n.locale === 'en'">
                        ...
                        <TestValue style="padding: 5px; color: whitesmoke" id="length-limit"
                            >{{
                                Math.round(Math.atan(this.propertyValue) * (180 / Math.PI))
                            }}°</TestValue
                        >
                    </TestConverted>
    ...
    <Modal :state="this.showBrowserCompatibility">
        <BrowserCompatibility
            ...
            :data="getBrowserSupportList('types', 'atan')"
            :reference="getFeatureReferenceURL('types', 'atan')"
        />
    </Modal>
</template>
